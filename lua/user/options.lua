...
vim.opt.undodir = "/tmp"			-- testing if works
...
vim.opt.guifont = "Victor Mono:h14"               -- the font used in graphical neovim applications
...
vim.cmd [[set formatoptions-=cro]] -- TODO: this doesn't seem to work-- :help options
